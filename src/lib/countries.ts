// ISO-3166 country list, English short name. Single source of truth used by
// the agent signup form and any future country selector. The "popular" subset
// surfaces at the top so Mauritius-bound visitors don't have to scroll.
...
const REST: Country[] = [
  ...
  { code: 'AR', name: 'Argentina' }, { code: 'AM', name: 'Armenia' }, { code: 'AT', name: 'Austria' },
  ...
  { code: 'FI', name: 'Finland' }, { code: 'GA', name: 'Gabon' }, { code: 'GM', name: 'Gambia' },
  ...
  { code: 'IS', name: 'Iceland' }, { code: 'ID', name: 'Indonesia' }, { code: 'IR', name: 'Iran' },
  ...
  { code: 'MR', name: 'Mauritania' }, { code: 'MX', name: 'Mexico' }, { code: 'FM', name: 'Micronesia' },
  ...
  { code: 'UG', name: 'Uganda' }, { code: 'UA', name: 'Ukraine' }, { code: 'UY', name: 'Uruguay' },
...
export const COUNTRIES: Country[] = [...POPULAR, ...REST.filter(c => !POPULAR.find(p => p.code === c.code))];
